...
class FedAveragingServer:
    ...
    def aggregate_weights(
        ...
        Args:
            client_indices: List of indices of participating clients
            client_weights: List of weight dicts from each client

        Returns:
            Aggregated weight dictionary
        """
        # Compute total samples across selected clients
