...
**Authors**: Cubuk, Zoph, Mane, Vasudevan, Le
**Year**: 2019
**arXiv**: 1805.09501
**Topic**: augmentation
...
tudes with which they are applied.
We use a search al-
...
lation, and rotation [54, 8, 62, 52].
On natural image
...
datasets.
Next, we will study the transferability of aug-
...
ing decay for the Wide-ResNet-28-10.
We then use the
...
fer well to many model architectures and datasets.
For
...
ciation. 5
[2] A. Antoniou, A. Storkey, and H. Edwards.
Data aug-
...
Y. Li, A. Bharambe, and L. van der Maaten.
Exploring
...
[52] I. Sato, H. Nishimura, and K. Yokoi.
Apac: Augmented
...
[54] P. Y. Simard, D. Steinkraus, J. C. Platt, et al.
Best prac-
...
ment:
Learning Augmentation policies
from Data”
