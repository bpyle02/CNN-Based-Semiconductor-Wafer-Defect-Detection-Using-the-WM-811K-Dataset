...
the accuracy of the model in cross validation.
We note
...
--- Page 3 ---
hundreds or thousands of features signiﬁcantly contribute
...
πx.
We sample instances around x′ by drawing nonzero
...
of diﬀerent values to future work. We use the same Ωfor
...
grayed out super-pixel. This particular choice of Ωmakes
...
3.5
Example 1: Text classiﬁcation with SVMs
...
the test instances in Figures 6 and 7.
We observe that
...
--- Page 7 ---
Table 1: Average F1 of trustworthiness for diﬀerent
...
6.2
Can users select the best classiﬁer?
...
with basic knowledge about religion.
We measure their
...
RP-LIME
No cleaning
Figure 10: Feature engineering experiment.
Each
...
6.3
Can non-experts improve a classiﬁer?
...
(b) Explanation
Figure 11:
Raw data and explanation of a bad
...
learning, speciﬁcally for vision tasks [3, 29]. Letting users
know when the systems are likely to fail can lead to an
increase in trust, by avoiding “silly mistakes” [8].
These
