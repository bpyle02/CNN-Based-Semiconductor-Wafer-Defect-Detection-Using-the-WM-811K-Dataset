...
Training image size.
Let S be the smallest side of an isotropically-rescaled training image, from
...
Karpathy, A. and Fei-Fei, L. Deep visual-semantic alignments for generating image descriptions.
CoRR,
abs/1412.2306, 2014.
...
Training.
Training of localisation ConvNets is similar to that of the classiﬁcation ConvNets
...
Testing.
We consider two testing protocols. The ﬁrst is used for comparing different network
...
is above 0.5.
Settings comparison.
As can be seen from Table 8, per-class regression (PCR) outperforms the
...
PCR
33.1
Fully-ﬂedged evaluation.
Having determined the best localisation setting (PCR, ﬁne-tuning of all
...
25.3
Comparison with the state of the art.
We compare our best localisation result with the state
...
Caltech-256
(mean AP)
(mean AP) (mean class recall) (mean class recall)
...
92.7 ± 0.5
86.2 ± 0.3
Image Classiﬁcation on VOC-2007 and VOC-2012.
We begin with the evaluation on the image
...
Action Classiﬁcation on VOC-2012.
We also evaluated our best-performing image representa-
...
Since the public release of our models, they have been actively used
by the research community for a wide range of image recognition tasks, consistently outperform-
ing more shallow representations.
For instance, Girshick et al. (2014) achieve the state of the
