...
37.3
45.6
Table 2. Object detection results using Fast R-CNN [11] on a ﬁxed set of proposals (RPN, {Pk}, Table 1(c)), evaluated on the COCO
...
In the above we used a ﬁxed set of proposals to investi-
...
We ﬁnd that our ResNet-101 model in Table 5 is not sufﬁ-
...
We use our feature pyramid networks to efﬁciently gen-
...
motivations from DeepMask/SharpMask [27, 28].
How-
...
ing many of the speciﬁcs, our implementation remains sim-
ilar in spirit to DeepMask. Speciﬁcally, to deﬁne the label
...
dict a mask at a different location. Speciﬁcally, at scale Pk,
