...
**Authors**: Touvron, Cord, Douze, Massa, Sablayrolles, Jegou
**Year**: 2021
**arXiv**: 2012.12877
**Topic**: transformer
...
1
arXiv:2012.12877v2  [cs.CV]  15 Jan 2021
...
(KD), introduced by Hinton et al. [24], refers to the
...
To get a full transformer block as in [52], we
...
Soft distillation
[24, 54] minimizes the Kullback-Leibler divergence between
...
--- Page 8 ---
We veriﬁed that our distillation token adds something to the model, com-
...
We use both the true label and teacher predic-
...
We compare the performance of differ-
...
[23] Dan Hendrycks and Kevin Gimpel.
...
--- Page 21 ---
[37] Jiasen Lu, Dhruv Batra, D. Parikh, and Stefan Lee.
...
[50] Hugo Touvron, Andrea Vedaldi, Matthijs Douze, and Herve Jegou.
Fixing the
train-test resolution discrepancy. NIPS, 2019.
[51] Hugo Touvron, Andrea Vedaldi, Matthijs Douze, and Herv´e J´egou.
Fixing the
