# WaferSegClassNet: Joint Wafer Defect Segmentation and Classification

**Authors**: Chen et al.
**Year**: 2023
**arXiv**: 2303.18223
**Topic**: wafer
**Relevance**: Multi-task seg+class on wafer maps
...
•
Academic Data.
In addition to book data, scientific
...
Summarize from Feedback [129]
Sep-2020
193K
SHP [191]
Oct-2021
385K
WebGPT Comparisons [81]
Dec-2021
19K
Stack Exchange Preferences [192]
Dec-2021
10M
HH-RLHF [183]
Apr-2022
169K
Sandbox Alignment Data [193]
May-2023
169K
CValues [194]
Jul-2023
...
• Utilizing the PRMs.
To effectively leverage process-
...
tokens.
Despite the effectiveness, recent work has also
...
method.
However, this method does not effectively con-
...
ers for LLM-based prompt optimization.
For example,
...
progressively generating better new prompts.
To further
...
documents that exhibit long-range coherence [490].
Fur-
...
37. Given k programs generated by the LLM, pass@k is computed as
...
Language Generation
Language Modeling
Penn Treebank [540], WikiText-103 [541], the Pile [166], LAMBADA [252]
...
Household
VirtualHome [608], BEHAVIOR [609], ALFRED [610],ALFWorld [611]
Website Environment
WebShop [612], Mind2Web [613]
Open World
MineRL [614], MineDojo [615]
Tool Manipulation
Search Engine
HotpotQA [581], TriviaQA [560], Natural Questions [556]
Code Executor
GSM8k [198], TabMWP [616], Date Understanding [70]
Calculator
GSM8k [198], MATH [362], CARP [617]
Model Interface
GPT4Tools [618], Gorilla [619]
Data Interface
...
with LLMs [81, 655, 659].
Also, previous work [660–662]
...
training.
Existing work [33, 432, 507] commonly evaluates
...
based supervision during training [690, 691].
As a promis-
...
and answering timely questions [80, 441].
However, as
...
40. In some cases, it is also called chat models.
...
ityPrompts, we utilize the Perspective-API42 for toxicity
...
mender systems as augmented input [817, 818].
As an-
...
--- Page 79 ---
79
angle t · θi, a smaller basis θi allows for a greater distance
t, i.e., enabling the modeling of longer texts [254, 295, 940].
According to the formula θi = b−2(i−1)/d in Equation 4,
...
Single-agent based Applications.
...
As a representative project, LangChain46 is a framework
...
binary operation Y = W X, calculating the gradient
∂Y
∂W
...
➀Q, K, V = XW Q,K,V
store X with size 2BTH
➁Q, K = RoPE(Q, K)
store Q and K with size 4BTH
➂O = Attn (Q, K, V )
store Q, K, and V
with size
6TH
and results of softmax
with size 2BT 2N
➃X = OW O
store O with size 2BTH
➄X = Add&Norm(X)
store X with size 2BTH
➅G, U = X[W G, W U]
store X with size 2BTH
➆D = Swish(G) · U
store G and U with size 4BTH′
➇X = DW D
store D with size 2BTH′
➈X = Add&Norm(X)
store X with size 2BTH
➉CE(softmax(XW L))
store X with size 2BTH and re-
...
will briefly review several representative PTQ methods48 for
LLMs.
...
tion.
To reduce the quantization error, a straightforward
...
• Bitsandbytes49 is developed based on the methods
introduced in the papers of LLM.int8() [1001] and 8-bit
49. https://github.com/TimDettmers/bitsandbytes
...
• GPTQ-for-LLaMA50 is developed specially for quantiz-
...
• AutoGPTQ51 is a quantization package developed
...
and BNScalePruner).
• LLM-Pruner54 is designed specifically for the pruning
...
settings).
56. https://openai.com/index/learning-to-reason-with-llms/
...
[10]
X. Liu and W. B. Croft, “Statistical language mod-
...
[12]
S. M. Thede and M. P. Harper, “A second-order
...
abs/2206.07682, 2022.
[32]
M. Shanahan, “Talking about large language mod-
...
[35]
R. Taylor, M. Kardas, G. Cucurull, T. Scialom,
...
neering, 2023, pp. 1–6.
[54]
W. X. Zhao, J. Liu, R. Ren, and J.-R. Wen, “Dense
...
[58]
T. Henighan, J. Kaplan, M. Katz, M. Chen, C. Hesse,
...
[59]
S. M. Xie, H. Pham, X. Dong, N. Du, H. Liu, Y. Lu,
...
[60]
P. Villalobos, J. Sevilla, L. Heim, T. Besiroglu,
...
2211.04325
[61]
N. Muennighoff, A. M. Rush, B. Barak, T. L. Scao,
...
[62]
I. McKenzie, A. Lyzhov, A. Parrish, A. Prabhu,
...
[78]
T. L. Scao, A. Fan, C. Akiki, E. Pavlick, S. Ilic,
...
2023.
[100]
A. Yang, B. Xiao, B. Wang, B. Zhang, C. Yin, C. Lv,
...
[102]
X. Li, Y. Yao, X. Jiang, X. Fang, X. Meng, S. Fan,
...
[103]
T. Wei, L. Zhao, L. Zhang, B. Zhu, L. Wang, H. Yang,
...
[109]
S. Wu, X. Zhao, T. Yu, R. Zhang, C. Shen, H. Liu,
...
pp. 5547–5569.
[113]
S. Smith, M. Patwary, B. Norick, P. LeGresley,
...
abs/2210.11399, 2022.
[119]
X. Ren, P. Zhou, X. Meng, X. Huang, Y. Wang,
...
[121]
A. Radford, R. J´ozefowicz, and I. Sutskever, “Learn-
...
2018.
[124]
Y. Zhang, S. Sun, M. Galley, Y. Chen, C. Brockett,
...
270–278.
[125]
D. Ham, J. Lee, Y. Jang, and K. Kim, “End-to-end
...
[126]
I. Drori, S. Tran, R. Wang, N. Cheng, K. Liu, L. Tang,
...
2021.
[127]
A. Neelakantan, T. Xu, R. Puri, A. Radford, J. M.
...
[130]
OpenAI, “Our approach to alignment research,” Ope-
nAI Blog, August 2022.
[131]
——, “Introducing chatgpt,” OpenAI Blog, November
2022.
[132]
...
[134]
——, “Lessons learned on language model safety
...
[136]
“Introducing Llama 3.1: Our most capable models to
...
[139]
T. Mesnard, C. Hardin, R. Dadashi, S. Bhupatiraju,
...
abs/2403.08295, 2024.
[140]
M. Rivi`ere, S. Pathak, P. G. Sessa, C. Hardin, S. Bhu-
...
[141]
A. Yang, B. Yang, B. Hui, B. Zheng, B. Yu, C. Zhou,
...
[143]
T. GLM, A. Zeng, B. Xu, B. Wang, C. Zhang, D. Yin,
...
[144]
H. Zhong, C. Xiao, C. Tu, T. Zhang, Z. Liu, and
...
2020, pp. 9701–9708.
[145]
D. Jin, E. Pan, N. Oufattole, W.-H. Weng, H. Fang,
...
[148]
Alpaca-LoRA, “Instruct-tune llama on consumer
hardware,”
...
[151]
Y. Ji, Y. Deng, Y. Gong, Y. Peng, Q. Niu, B. Ma,
...
[153]
D. Eccleston, “Sharegpt,” https://sharegpt.com/,
2023.
[154]
...
[156]
W. Dai, J. Li, D. Li, A. M. H. Tiong, J. Zhao, W. Wang,
...
[157]
Y. Su, T. Lan, H. Li, J. Xu, Y. Wang, and D. Cai,
“Pandagpt: One model to instruction-follow them
all,” 2023.
[158]
Y. Zhu, R. Kiros, R. S. Zemel, R. Salakhutdinov,
...
//www.gutenberg.org/
[160]
T. H. Trinh and Q. V. Le, “A simple method for com-
...
[163]
J. Baumgartner, S. Zannettou, B. Keegan, M. Squire,
...
abs/2101.00027, 2021.
[167]
H. Laurenc¸on, L. Saulnier, T. Wang, C. Akiki, A. V.
...
commoncrawl.org/
[169]
G. Wenzek, M.-A. Lachaux, A. Conneau, V. Chaud-
...
4012.
[170]
T. Computer, “Redpajama: an open dataset for train-
ing large language models,” https://github.com/
togethercomputer/RedPajama-Data, 2023.
[171]
G. Penedo, Q. Malartic, D. Hesslow, R. Cojocaru,
...
[176]
B. Wang and A. Komatsuzaki, “GPT-J-6B: A 6 Billion
...
[178]
D. Groeneveld, I. Beltagy, P. Walsh, A. Bhagia, R. Kin-
...
2024.
[179]
S. Mishra, D. Khashabi, C. Baral, and H. Ha-
...
3487.
[180]
S. H. Bach, V. Sanh, Z. X. Yong, A. Webson, C. Raffel,
...
arXiv.2204.05862
[184]
B. Guo, X. Zhang, Z. Wang, M. Jiang, J. Nie, Y. Ding,
...
[185]
M. Conover, M. Hayes, A. Mathur, J. Xie, J. Wan,
...
[186]
A. K¨opf, Y. Kilcher, D. von R¨utte, S. Anagnostidis, Z.-
...
2023.
[188]
J. Cheung, “Guanaco - generative universal assistant
...
[190]
Y. Ji, Y. Gong, Y. Deng, Y. Peng, Q. Niu, B. Ma,
...
[191]
K. Ethayarajh, Y. Choi, and S. Swayamdipta, “Under-
...
[193]
R. Liu, R. Yang, C. Jia, G. Zhang, D. Zhou, A. M.
...
[194]
G. Xu, J. Liu, M. Yan, H. Xu, J. Si, Z. Zhou, P. Yi,
...
[195]
J. Dai, X. Pan, R. Sun, J. Ji, X. Xu, M. Liu, Y. Wang, and
...
OpenReview.net, 2022.
[197]
S. Longpre, L. Hou, T. Vu, A. Webson, H. W.
...
abs/2110.14168, 2021.
[199]
M. Geva, D. Khashabi, E. Segal, T. Khot, D. Roth,
...
[206]
“Bmtrain: Effient training for big models.” [Online].
...
[209]
(2023) Deepspeed-mii. [Online]. Available: https:
//github.com/microsoft/DeepSpeed-MII
[210]
Z. Yao, R. Y. Aminabadi, O. Ruwase, S. Rajbhan-
...
[217]
S. Roller, E. Dinan, N. Goyal, D. Ju, M. Williamson,
...
[218]
A. Lewkowycz, A. Andreassen, D. Dohan, E. Dyer,
...
abs/2206.14858, 2022.
[219]
T. Saier, J. Krause, and M. F¨arber, “unarxive 2022:
...
[220]
H. A. Simon, “Experiments with a heuristic com-
piler,” J. ACM, vol. 10, no. 4, pp. 493–506, 1963.
[221]
Z. Manna and R. J. Waldinger, “Toward automatic
...
abs/2108.07732, 2021.
[224]
S. Black, L. Gao, P. Wang, C. Leahy, and S. Bider-
...
[226]
A. Madaan, S. Zhou, U. Alon, Y. Yang, and G. Neu-
...
[227]
S. Longpre, G. Yauney, E. Reif, K. Lee, A. Roberts,
...
[228]
D. Chen, Y. Huang, Z. Ma, H. Chen, X. Pan, C. Ge,
...
[229]
M. Abdin, S. A. Jacobs, A. A. Awan, J. Aneja,
...
[230]
G. Penedo, H. Kydl´ıˇcek, A. Lozhkov, M. Mitchell,
...
[231]
P. Maini, S. Seto, H. Bai, D. Grangier, Y. Zhang, and
...
8424–8445.
[237]
N. Carlini, D. Ippolito, M. Jagielski, K. Lee, F. Tram`er,
and C. Zhang, “Quantifying memorization across
neural language models,” CoRR, 2022.
[238]
N. Kandpal, E. Wallace, and C. Raffel, “Deduplicat-
...
2001, pp. 282–289.
[240]
P. Gage, “A new algorithm for data compression,” C
Users Journal, vol. 12, no. 2, pp. 23–38, 1994.
[241]
R. Sennrich, B. Haddow, and A. Birch, “Neural ma-
...
[242]
M. Schuster and K. Nakajima, “Japanese and korean
...
abs/1609.08144, 2016.
[244]
T. Kudo, “Subword regularization: Improving neural
...
[245]
T. Kudo and J. Richardson, “Sentencepiece: A simple
...
ber 4, 2018, E. Blanco and W. Lu, Eds.
Association
for Computational Linguistics, 2018.
[246]
M. Davis and M. D¨urst, “Unicode normalization
forms,” 2001.
[247]
P. Nakkiran, G. Kaplun, Y. Bansal, T. Yang, B. Barak,
...
2016.
[253]
M. F. Chen, N. Roberts, K. Bhatia, J. Wang, C. Zhang,
...
2023.
[257]
S. Tworkowski, K. Staniszewski, M. Pacek, Y. Wu,
...
[263]
B. Zhang, B. Ghorbani, A. Bapna, Y. Cheng, X. Garcia,
...
[264]
L. Dong, N. Yang, W. Wang, F. Wei, X. Liu, Y. Wang,
...
13 042–13 054.
[265]
A. Clark, D. de Las Casas, A. Guy, A. Mensch,
...
pp. 4057–4086.
[266]
A. Gu, K. Goel, and C. R´e, “Efficiently modeling
long
sequences
with
structured
...
[271]
Y. Sun, L. Dong, S. Huang, S. Ma, Y. Xia, J. Xue,
...
abs/2312.00752, 2023.
[273]
B. Peng, E. Alcaide, Q. Anthony, A. Albalak, S. Ar-
...
2023.
[274]
M. Ding, Z. Yang, W. Hong, W. Zheng, C. Zhou,
...
[275]
L. J. Ba, J. R. Kiros, and G. E. Hinton, “Layer normal-
ization,” vol. abs/1607.06450, 2016.
[276]
B. Zhang and R. Sennrich, “Root mean square layer
...
12 360–12 371.
[277]
H. Wang, S. Ma, L. Dong, S. Huang, D. Zhang,
...
[283]
O. Press, N. A. Smith, and M. Lewis, “Train short,
...
[285]
S. Narang, H. W. Chung, Y. Tay, L. Fedus, T. F´evry,
...
ICML, 2020.
[287]
A. Baevski and M. Auli, “Adaptive input repre-
sentations for neural language modeling,” in 7th
International Conference on Learning Representations,
ICLR 2019, New Orleans, LA, USA, May 6-9, 2019.
OpenReview.net, 2019.
[288]
L. Liu, X. Liu, J. Gao, W. Chen, and J. Han, “Under-
...
[289]
D. Hendrycks and K. Gimpel, “Gaussian error linear
...
[291]
T. L. Scao, T. Wang, D. Hesslow, S. Bekman, M. S.
...
[294]
Z. Yang, Z. Dai, Y. Yang, J. Carbonell, R. R. Salakhut-
...
[297]
H. Peng, N. Pappas, D. Yogatama, R. Schwartz, N. A.
...
[298]
M. Zaheer, G. Guruganesh, K. A. Dubey, J. Ainslie,
...
[299]
R. Child, S. Gray, A. Radford, and I. Sutskever, “Gen-
...
02150
[301]
J. Ainslie, J. Lee-Thorp, M. de Jong, Y. Zemlyanskiy,
...
[303]
T. Dao, “Flashattention-2: Faster attention with better
...
ai/
[305]
K. Murray and D. Chiang, “Correcting length bias in
...
abs/1609.08144, 2016.
[310]
R. Paulus, C. Xiong, and R. Socher, “A deep re-
inforced model for abstractive summarization,” in
ICLR (Poster).
OpenReview.net, 2018.
[311]
A. K. Vijayakumar, M. Cogswell, R. R. Selvaraju,
...
[319]
I. Loshchilov and F. Hutter, “Fixing weight decay
regularization in adam,” CoRR, vol. abs/1711.05101,
2017.
[320]
N. Shazeer and M. Stern, “Adafactor: Adaptive
...
[321]
Y. Huang, Y. Cheng, A. Bapna, O. Firat, D. Chen,
...
2019, pp. 103–112.
[322]
A. Harlap, D. Narayanan, A. Phanishayee, V. Se-
...
[323]
P. Micikevicius, S. Narang, J. Alben, G. F. Di-
...
2022, pp. 559–578.
[329]
T. Chen, B. Xu, C. Zhang, and C. Guestrin, “Training
...
[334]
S. Longpre, L. Hou, T. Vu, A. Webson, H. W. Chung,
...
abs/2301.13688, 2023.
[335]
C. Xu, Q. Sun, K. Zheng, X. Geng, P. Zhao, J. Feng,
...
[339]
L. Chen, S. Li, J. Yan, H. Wang, K. Gunaratna, V. Ya-
...
[340]
S. Mukherjee, A. Mitra, G. Jawahar, S. Agarwal,
...
YuLan-Chat, 2023.
[342]
Y. Huang, X. Liu, Y. Gong, Z. Gou, Y. Shen, N. Duan,
...
[344]
K. Zhou, B. Zhang, J. Wang, Z. Chen, W. X. Zhao,
...
abs/2405.14365, 2024.
[345]
Y. Cao, Y. Kang, and L. Sun, “Instruction mining:
...
1894.
[350]
Y. Wang, H. Ivison, P. Dasigi, J. Hessel, T. Khot, K. R.
...
[352]
B. Peng, C. Li, P. He, M. Galley, and J. Gao, “Instruc-
tion tuning with GPT-4,” CoRR, vol. abs/2304.03277,
2023.
[353]
M. M. Krell, M. Kosec, S. P. Perez, and A. Fitzgib-
...
[355]
J. Zhang, R. Xie, Y. Hou, W. X. Zhao, L. Lin, and
...
[359]
T. Liu and B. K. H. Low, “Goat: Fine-tuned llama out-
performs gpt-4 on arithmetic tasks,” arXiv preprint
arXiv:2305.14201, 2023.
[360]
T. Sun, X. Zhang, Z. He, P. Li, Q. Cheng, H. Yan,
...
2023.
[361]
Y. Dubois, X. Li, R. Taori, T. Zhang, I. Gulrajani,
...
[365]
D. M. Ziegler, N. Stiennon, J. Wu, T. B. Brown,
...
for alignment,” CoRR, vol. abs/2112.00861, 2021.
[367]
E. Perez, S. Huang, H. F. Song, T. Cai, R. Ring,
...
[370]
H. Lee, S. Phatale, H. Mansoor, K. Lu, T. Mesnard,
...
[371]
H. Dong, W. Xiong, D. Goyal, R. Pan, S. Diao,
J.
Zhang,
K.
Shum,
...
2304.06767
[372]
A. Askell, Y. Bai, A. Chen, D. Drain, D. Gan-
...
and Benchmarks, 2021.
[377]
T. Wang, P. Yu, X. E. Tan, S. O’Brien, R. Pa-
...
[381]
Z. Xi, W. Chen, B. Hong, S. Jin, R. Zheng, W. He,
...
[383]
T. Anthony, Z. Tian, and D. Barber, “Thinking fast
...
[384]
H. Luo, Q. Sun, C. Xu, P. Zhao, J. Lou, C. Tao,
...
[385]
R. Liu, C. Jia, G. Zhang, Z. Zhuang, T. X. Liu, and
...
[389]
R. Krishna, D. Lee, L. Fei-Fei, and M. S. Bernstein,
“Socially
situated
artificial
intelligence
...
[390]
H. Liu, C. Sferrazza, and P. Abbeel, “Chain of hind-
...
2024.
[396]
D. Kim, Y. Kim, W. Song, H. Kim, Y. Kim, S. Kim,
...
watch?v=hhiLw5Q UFg
[404]
X. L. Li and P. Liang, “Prefix-tuning: Optimizing
...
[407]
Z. Hu, Y. Lan, L. Wang, W. Xu, E. Lim, R. K. Lee,
...
[408]
J. He, C. Zhou, X. Ma, T. Berg-Kirkpatrick, and
...
pp. 423–438, 2020.
[413]
T. Shin, Y. Razeghi, R. L. Logan IV, E. Wallace,
...
[414]
Q. Zhang, M. Chen, A. Bukharin, P. He, Y. Cheng,
...
[415]
M. Valipour, M. Rezagholizadeh, I. Kobyzev, and
A.
Ghodsi,
“Dylora:
Parameter
...
arXiv.2210.07558
[416]
N. Ding, Y. Qin, G. Yang, F. Wei, Y. Zonghan, Y. Su,
...
[417]
R. Zhang, J. Han, A. Zhou, X. Hu, S. Yan, P. Lu, H. Li,
...
[418]
J. Pfeiffer, I. Vulic, I. Gurevych, and S. Ruder, “MAD-
...
ber, T. Cohn, Y. He, and Y. Liu, Eds.
Association for
Computational Linguistics, 2020, pp. 7654–7673.
[419]
S. Mangrulkar, S. Gugger, L. Debut, Y. Belkada,
and
S.
Paul,
“Peft:
...
[420]
J. Liu, D. Shen, Y. Zhang, B. Dolan, L. Carin, and
...
100–114.
[421]
O. Rubin, J. Herzig, and J. Berant, “Learning to
...
2671.
[422]
H. J. Kim, H. Cho, J. Kim, T. Kim, K. M. Yoo, and
...
2023.
[424]
Y. Hao, Y. Sun, L. Dong, Z. Han, Y. Gu, and F. Wei,
“Structured prompting: Scaling in-context learning
to 1, 000 examples,” CoRR, 2022.
[425]
Y. Lu, M. Bartolo, A. Moore, S. Riedel, and P. Stene-
...
[432]
D. Zhou, N. Sch¨arli, L. Hou, J. Wei, N. Scales,
...
[434]
L. Wang, W. Xu, Y. Lan, Z. Hu, Y. Lan, R. K.
Lee,
and
E.
Lim,
...
[439]
Y. Lu, P. Lu, Z. Chen, W. Zhu, X. E. Wang, and W. Y.
...
2023.
[441]
Z. Chen, K. Zhou, B. Zhang, Z. Gong, W. X.
...
abs/2210.03629, 2022.
[443]
N. Shinn, F. Cassano, B. Labash, A. Gopinath,
...
[445]
V. Liu and L. B. Chilton, “Design guidelines for
...
[446]
J. White, Q. Fu, S. Hays, M. Sandborn, C. Olea,
...
[447]
S. K. K. Santu and D. Feng, “Teler: A general
taxonomy
of
LLM
prompts
...
[451]
J. Jiang, K. Zhou, Z. Dong, K. Ye, W. X. Zhao, and
...
[454]
R. Ren, Y. Wang, Y. Qu, W. X. Zhao, J. Liu, H. Tian,
...
[458]
Y. Wen, N. Jain, J. Kirchenbauer, M. Goldblum,
J.
Geiping,
and
T.
...
[461]
X. Lin, Z. Wu, Z. Dai, W. Hu, Y. Shu, S. Ng, P. Jaillet,
...
[462]
M. Deng, J. Wang, C. Hsieh, Y. Wang, H. Guo, T. Shu,
...
3369–3391.
[463]
T. Zhang, X. Wang, D. Zhou, D. Schuurmans, and
...
view.net, 2023.
[464]
Y. Jafari, D. Mekala, R. Yu, and T. Berg-Kirkpatrick,
“Morl-prompt:
An
empirical
analysis
...
Review.net, 2023.
[469]
R. Pryzant, D. Iter, J. Li, Y. T. Lee, C. Zhu,
...
[474]
Q. Guo, R. Wang, J. Guo, B. Li, K. Song, X. Tan,
...
abs/2309.08532, 2023.
[475]
X. L. Do, Y. Zhao, H. Brown, Y. Xie, J. X. Zhao, N. F.
...
[477]
T. Tang, J. Li, W. X. Zhao, and J. Wen, “Context-
...
S. Na, Eds.
International Committee on Computa-
...
[482]
Y. Lee, C. Lim, and H. Choi, “Does GPT-3 generate
...
[485]
X. Ye, S. Iyer, A. Celikyilmaz, V. Stoyanov, G. Durrett,
and R. Pasunuru, “Complementary explanations for
effective in-context learning,” CoRR, 2022.
[486]
X. Li and X. Qiu, “Finding supporting examples for
in-context learning,” CoRR, 2023.
[487]
Y. Zhang, S. Feng, and C. Tan, “Active example
...
9148.
[488]
F. Gilardi, M. Alizadeh, and M. Kubli, “Chatgpt out-
...
Event, April 25-29, 2022, 2022.
[491]
Z. Wu, Y. Wang, J. Ye, and L. Kong, “Self-adaptive in-
context learning,” CoRR, vol. abs/2212.10375, 2022.
[492]
Y. Gu, L. Dong, F. Wei, and M. Huang, “Pre-training
...
[502]
J. Coda-Forno, M. Binz, Z. Akata, M. M. Botvinick,
J.
X.
Wang,
and
...
abs/2305.12907, 2023.
[503]
J. W. Wei, L. Hou, A. K. Lampinen, X. Chen,
...
2023.
[504]
Z. Chu, J. Chen, Q. Chen, W. Yu, T. He, H. Wang,
...
[505]
S. Miao, C. Liang, and K. Su, “A diverse corpus
...
[506]
A. Talmor, J. Herzig, N. Lourie, and J. Berant, “Com-
...
[508]
W. Chen, X. Ma, X. Wang, and W. W. Cohen, “Pro-
...
abs/2210.03057, 2022.
[527]
J. Qian, H. Wang, Z. Li, S. Li, and X. Yan, “Limita-
...
[538]
J. Wang, X. Yi, R. Guo, H. Jin, P. Xu, S. Li, X. Wang,
...
machine translation,” in WMT@ACL.
The Associa-
...
[544]
L. Barrault, O. Bojar, M. R. Costa-juss`a, C. Feder-
...
[546]
F. Akhbardeh, A. Arkhangorodsky, M. Biesialska,
...
[547]
T. Kocmi, R. Bawden, O. Bojar, A. Dvorkovich, C. Fe-
...
2022.
[549]
R. Bawden, E. Bilinski, T. Lavergne, and S. Rosset,
...
[550]
R. Nallapati, B. Zhou, C. N. dos Santos, C¸ . G¨ulc¸ehre,
...
ACL, 2016, pp. 280–290.
[551]
S. Narayan, S. B. Cohen, and M. Lapata, “Don’t give
...
[553]
S. Moon, P. Shah, A. Kumar, and R. Subba, “Open-
...
[558]
S. Lin, J. Hilton, and O. Evans, “Truthfulqa: Measur-
...
3214–3252.
[559]
J. Berant, A. Chou, R. Frostig, and P. Liang, “Semantic
...
pp. 69–78.
[563]
Y. Gu, S. Kase, M. Vanni, B. M. Sadler, P. Liang,
...
3477–3488.
[564]
S. Cao, J. Shi, L. Pan, L. Nie, Y. Xiang, L. Hou,
...
6101–6119.
[565]
X. Hu, X. Wu, Y. Shu, and Y. Qu, “Logical form gen-
...
[566]
S. Longpre, Y. Lu, and J. Daiber, “MKQA: A lin-
...
[567]
T. Saikh, T. Ghosal, A. Mittal, A. Ekbal, and P. Bhat-
...
[570]
T. Khot, P. Clark, M. Guerquin, P. Jansen, and A. Sab-
...
[573]
B. Goodrich, V. Rao, P. J. Liu, and M. Saleh, “As-
...
2019, pp. 166–175.
[574]
K. Toutanova and D. Chen, “Observed versus latent
...
[575]
K. D. Bollacker, C. Evans, P. K. Paritosh, T. Sturge,
...
[578]
F. Petroni, T. Rockt¨aschel, S. Riedel, P. S. H. Lewis,
...
2473.
[579]
F. Mahdisoltani, J. Biega, and F. M. Suchanek,
...
2011.
[587]
K. Sakaguchi, C. Bhagavatula, R. L. Bras, N. Tandon,
...
2021, pp. 2138–2149.
[588]
B. Dalvi, L. Huang, N. Tandon, W. Yih, and P. Clark,
...
[589]
S. Saha, P. Yadav, L. Bauer, and M. Bansal, “Expla-
...
[591]
B. Dalvi, P. Jansen, O. Tafjord, Z. Xie, H. Smith, L. Pi-
...
[592]
A. Saparov and H. He, “Language models are greedy
...
126
[593]
C. Anil, Y. Wu, A. Andreassen, A. Lewkowycz,
...
abs/2207.04901, 2022.
[594]
A. Patel, S. Bhattamishra, and N. Goyal, “Are NLP
models really able to solve simple math word prob-
lems?” in NAACL-HLT.
Association for Computa-
tional Linguistics, 2021, pp. 2080–2094.
[595]
S. Roy and D. Roth, “Solving general arithmetic
...
[596]
A. Amini, S. Gabriel, S. Lin, R. Koncel-Kedziorski,
...
[597]
W. Ling, D. Yogatama, C. Dyer, and P. Blunsom, “Pro-
...
[598]
R. Koncel-Kedziorski, S. Roy, A. Amini, N. Kushman,
...
2378.
[600]
S. Welleck, J. Liu, R. L. Bras, H. Hajishirzi, Y. Choi,
...
OpenReview.net, 2022.
[603]
Z. Azerbayev, B. Piotrowski, H. Schoelkopf, E. W.
...
[604]
J. Li, X. Cheng, W. X. Zhao, J. Nie, and J. Wen,
...
[606]
R. Rudinger, J. Naradowsky, B. Leonard, and B. V.
...
[608]
X. Puig, K. Ra, M. Boben, J. Li, T. Wang, S. Fidler,
and A. Torralba, “Virtualhome: Simulating house-
hold activities via programs,” in CVPR.
Computer
Vision Foundation / IEEE Computer Society, 2018,
pp. 8494–8502.
[609]
S. Srivastava, C. Li, M. Lingelbach, R. Mart´ın-Mart´ın,
...
OpenReview.net, 2021.
[612]
S. Yao, H. Chen, J. Yang, and K. Narasimhan, “Web-
...
127
[613]
X. Deng, Y. Gu, B. Zheng, S. Chen, S. Stevens,
...
China, August 10-16, 2019, S. Kraus, Ed.
ijcai.org,
2019, pp. 2442–2448.
[615]
L. Fan, G. Wang, Y. Jiang, A. Mandlekar, Y. Yang,
...
2022.
[616]
P. Lu, L. Qiu, K. Chang, Y. N. Wu, S. Zhu, T. Rajpuro-
...
[617]
B. Zhang, K. Zhou, X. Wei, W. X. Zhao, J. Sha,
...
[618]
R. Yang, L. Song, Y. Li, S. Zhao, Y. Ge, X. Li,
...
Berlin, Germany, Volume 2: Short Papers.
The Associ-
ation for Computer Linguistics, 2016.
[621]
H. Puerto, G. G. Sahin, and I. Gurevych, “Metaqa:
...
[622]
P. Pasupat and P. Liang, “Compositional semantic
...
[635]
K. Yang, Y. Tian, N. Peng, and D. Klein, “Re3: Gen-
...
[639]
M. Welsh, “The end of programming,” Commun.
...
2023.
[641]
Y. Liu, A. R. Fabbri, P. Liu, Y. Zhao, L. Nan, R. Han,
...
[642]
A. R. Fabbri, W. Kryscinski, B. McCann, C. Xiong,
R.
Socher,
and
D.
...
[645]
M. Gao, J. Ruan, R. Sun, X. Yin, S. Yang, and X. Wan,
“Human-like summarization evaluation with chat-
gpt,” CoRR, vol. abs/2304.02554, 2023.
[646]
Y. Ji, Y. Gong, Y. Peng, C. Ni, P. Sun, D. Pan, B. Ma,
...
[647]
Y. Bai, J. Ying, Y. Cao, X. Lv, Y. He, X. Wang, J. Yu,
...
2023.
[648]
Y. Liu, S. Feng, D. Wang, Y. Zhang, and H. Sch¨utze,
“Evaluate
what
you
can’t
...
[651]
M. McCloskey and N. J. Cohen, “Catastrophic in-
...
[652]
R. Kemker, M. McClure, A. Abitino, T. L. Hayes,
...
3390–3398.
[653]
T. Xie, C. H. Wu, P. Shi, R. Zhong, T. Scholak,
...
text-to-text language models,” in EMNLP.
Associ-
ation for Computational Linguistics, 2022, pp. 602–
631.
[654]
A. Roberts, C. Raffel, and N. Shazeer, “How much
...
5418–5426.
[655]
G. Izacard, P. S. H. Lewis, M. Lomeli, L. Hos-
...
[657]
P. S. H. Lewis, E. Perez, A. Piktus, F. Petroni,
...
2020, virtual, 2020.
[658]
Y. Lan, G. He, J. Jiang, J. Jiang, W. X. Zhao, and J. Wen,
...
pp. 2206–2240.
[660]
S. Xu, L. Pang, H. Shen, X. Cheng, and T.-S. Chua,
...
[661]
B. Peng, M. Galley, P. He, H. Cheng, Y. Xie, Y. Hu,
...
[662]
Z. Jiang, F. F. Xu, L. Gao, Z. Sun, Q. Liu, J. Dwivedi-
Yu,
Y.
Yang,
J.
...
abs/2305.06983, 2023.
[663]
L. Huang, W. Yu, W. Ma, W. Zhong, Z. Feng,
...
[668]
A. Lazaridou, E. Gribovskaya, W. Stokowiec, and
...
[669]
H. Qian, Y. Zhu, Z. Dou, H. Gu, X. Zhang, Z. Liu,
...
abs/2304.04358, 2023.
[670]
J. Liu, J. Jin, Z. Wang, J. Cheng, Z. Dou, and J. Wen,
...
[674]
Y. Yao, P. Wang, B. Tian, S. Cheng, Z. Li, S. Deng,
...
[676]
Z. Shao, Y. Gong, Y. Shen, M. Huang, N. Duan, and
...
[677]
Sifatkaur, M. Singh, V. S. B, and N. Malviya, “Mind
...
induction,” CoRR, vol. abs/2208.05051, 2022.
[680]
W. X. Zhao, K. Zhou, Z. Gong, B. Zhang, Y. Zhou,
...
2022, pp. 4571–4581.
[681]
Q. Wang, C. Kaliszyk, and J. Urban, “First experi-
...
[682]
S. Polu and I. Sutskever, “Generative language mod-
eling for automated theorem proving,” CoRR, vol.
abs/2009.03393, 2020.
[683]
A. Q. Jiang, W. Li, S. Tworkowski, K. Czechowski,
...
2023.
[688]
N. Shinn, B. Labash, and A. Gopinath, “Reflexion: an
...
[693]
X. Pi, Q. Liu, B. Chen, M. Ziyadi, Z. Lin, Q. Fu,
...
[694]
H. Zhou, A. Nova, H. Larochelle, A. C. Courville,
...
sive apis,” CoRR, vol. abs/2305.15334, 2023.
[705]
S. Hao, T. Liu, Z. Wang, and Z. Hu, “Toolkengpt:
...
abs/2305.17126, 2023.
[708]
J. Huang, S. S. Gu, L. Hou, Y. Wu, X. Wang,
...
131
[711]
H. Zeng, “Measuring massive multitask chinese un-
derstanding,” CoRR, vol. abs/2304.12986, 2023.
[712]
C. Liu, R. Jin, Y. Ren, L. Yu, T. Dong, X. Peng,
...
abs/2305.08322, 2023.
[714]
Z. Gu, X. Zhu, H. Ye, L. Zhang, J. Wang, S. Jiang,
...
[717]
J. Yu, X. Wang, S. Tu, S. Cao, D. Zhang-li, X. Lv,
...
[718]
T. Sawada, D. Paleka, A. Havrilla, P. Tadepalli, P. Vi-
...
2023.
[719]
Y. Peng, S. Li, W. Gu, Y. Li, W. Wang, C. Gao, and
...
[721]
Q. Tang, Z. Deng, H. Lin, X. Han, Q. Liang, and
...
2023.
[724]
Z. Liu, W. Yao, J. Zhang, L. Xue, S. Heinecke,
R.
Murthy,
Y.
Feng,
...
abs/2308.05960, 2023.
[725]
X. Liu, H. Yu, H. Zhang, Y. Xu, X. Lei, H. Lai,
...
[728]
N. Guha, D. E. Ho, J. Nyarko, and C. R´e, “Legal-
...
abs/2306.05685, 2023.
[730]
X. Wang, Z. Hu, P. Lu, Y. Zhu, J. Zhang, S. Sub-
...
[731]
X. Li, T. Zhang, Y. Dubois, R. Taori, I. Gulrajani,
...
alpaca eval, 2023.
[732]
Y. Huang, Q. Zhang, P. S. Yu, and L. Sun, “Trustgpt:
...
2023.
[734]
C. Chan, W. Chen, Y. Su, J. Yu, W. Xue, S. Zhang, J. Fu,
...
2023.
[737]
J. H. Clark, J. Palomaki, V. Nikolaev, E. Choi, D. Gar-
...
[738]
L. Gao, J. Tow, S. Biderman, S. Black, A. DiPofi,
...
[739]
R. Shah, K. Chawla, D. Eidnani, A. Shah, W. Du,
S. Chava, N. Raman, C. Smiley, J. Chen, and D. Yang,
...
422.
[742]
Y. Zhao, M. Khalman, R. Joshi, S. Narayan, M. Saleh,
...
[744]
X. Zhu, J. Wang, L. Zhang, Y. Zhang, R. Gan,
...
[745]
A. Nguyen, N. Karampatziakis, and W. Chen, “Meet
...
[748]
B. Yang, C. Han, Y. Li, L. Zuo, and Z. Yu, “Improv-
...
[750]
S. Martin, J. Liermann, and H. Ney, “Algorithms for
...
2021.
[754]
N. Alex, E. Lifland, L. Tunstall, A. Thakur, P. Maham,
...
pp. 2145–2158.
[760]
F. Souza, R. Nogueira, and R. Lotufo, “Portuguese
named entity recognition using bert-crf,” arXiv
preprint arXiv:1909.10649, 2019.
[761]
S. Pawar, G. K. Palshikar, and P. Bhattacharyya,
“Relation
extraction:
A
survey,”
...
[762]
C. Walker and et al., “Ace 2005 multilingual training
corpus ldc2006t06,” Philadelphia, 2006.
[763]
J. Gao, H. Zhao, C. Yu, and R. Xu, “Exploring the
...
abs/2303.03836, 2023.
[764]
Y. Ma, Y. Cao, Y. Hong, and A. Sun, “Large language
...
[766]
X. Wei, X. Cui, N. Cheng, X. Wang, X. Zhang,
...
[770]
L. Wang, C. Lyu, T. Ji, Z. Zhang, D. Yu, S. Shi,
and
Z.
Tu,
“Document-level
...
[773]
J. Kocon, I. Cichecki, O. Kaszyca, M. Kochanek,
...
2023.
[774]
Q. Zhong, L. Ding, J. Liu, B. Du, and D. Tao,
...
abs/2302.10198, 2023.
[775]
D. Cheng, S. Huang, J. Bi, Y. Zhan, J. Liu, Y. Wang,
...
[776]
R. Ren, Y. Qu, J. Liu, W. X. Zhao, Q. She, H. Wu,
...
[778]
Z. Qin, R. Jagerman, K. Hui, H. Zhuang, J. Wu,
...
[779]
S. Cho, S. Jeong, J. Seo, and J. C. Park, “Discrete
...
[783]
H. Zhuang, Z. Qin, K. Hui, J. Wu, L. Yan, X. Wang,
...
[787]
Y. Tay, V. Q. Tran, M. Dehghani, J. Ni, D. Bahri,
...
Systems, 2022.
[788]
R. Ren, W. X. Zhao, J. Liu, H. Wu, J.-R. Wen,
...
acl-long.336
[789]
Y. Qu, Y. Ding, J. Liu, K. Liu, R. Ren, W. X. Zhao,
...
[793]
A. Askari, M. Aliannejadi, E. Kanoulas, and S. Ver-
...
2023.
[794]
K. Mao, Z. Dou, H. Chen, F. Mo, and H. Qian, “Large
...
[795]
L. Gao, X. Ma, J. Lin, and J. Callan, “Precise zero-
...
1762–1777.
[796]
L. Wang, N. Yang, and F. Wei, “Query2doc: Query ex-
pansion with large language models,” arXiv preprint
arXiv:2303.07678, 2023.
[797]
G. Ma, X. Wu, P. Wang, Z. Lin, and S. Hu, “Pre-
...
[798]
W. Sun, Z. Chen, X. Ma, L. Yan, S. Wang, P. Ren,
...
Z. Huang, and H. Tong, Eds.
ACM, 2021, pp. 4653–
4664.
[802]
K. Zhou, H. Wang, W. X. Zhao, Y. Zhu, S. Wang,
...
P. Cudr´e-Mauroux, Eds.
ACM, 2020, pp. 1893–1902.
[803]
W. X. Zhao, Y. Hou, X. Pan, C. Yang, Z. Zhang, Z. Lin,
...
L. Xiong, Eds.
ACM, 2022, pp. 4722–4726.
[804]
L. Xu, Z. Tian, G. Zhang, J. Zhang, L. Wang, B. Zheng,
...
M. P. Kato, J. Mothe, and B. Poblete, Eds.
ACM,
2023, pp. 2837–2847.
[805]
S.
...
zato, and Y. Song, Eds.
ACM, 2023, pp. 1007–1014.
[813]
Y. Zhu, L. Wu, Q. Guo, L. Hong, and J. Li, “Col-
...
[815]
Y. Xi, W. Liu, J. Lin, J. Zhu, B. Chen, R. Tang,
...
abs/2306.10933, 2023.
[816]
Q. Liu, N. Chen, T. Sakai, and X. Wu, “A first look
at llm-powered generative news recommendation,”
CoRR, vol. abs/2305.06566, 2023.
[817]
R. Li, W. Deng, Y. Cheng, Z. Yuan, J. Zhang,
and
F.
Yuan,
“Exploring
...
abs/2305.11700, 2023.
[818]
W. Wei, X. Ren, J. Tang, Q. Wang, L. Su, S. Cheng,
...
[824]
J. Zhang, Y. Hou, R. Xie, W. Sun, J. J. McAuley,
...
2023.
[825]
A. Zhang, L. Sheng, Y. Chen, H. Li, Y. Deng, X. Wang,
and T. Chua, “On generative agents in recommenda-
tion,” CoRR, vol. abs/2310.10108, 2023.
[826]
Y. Du, Z. Liu, J. Li, and W. X. Zhao, “A survey of
...
July 2022, L. D. Raedt, Ed.
ijcai.org, 2022, pp. 5436–
5443.
[827]
...
listen,” CoRR, 2023.
[829]
J. Alayrac, J. Donahue, P. Luc, A. Miech, I. Barr,
Y.
Hasson,
K.
Lenc,
...
2022.
[830]
C. Schuhmann, R. Beaumont, R. Vencu, C. Gordon,
...
nition, CVPR 2021, virtual, June 19-25, 2021.
Com-
puter Vision Foundation / IEEE, 2021, pp. 3558–3568.
[832]
Q. Ye, H. Xu, G. Xu, J. Ye, M. Yan, Y. Zhou, J. Wang,
...
[833]
J. Bai, S. Bai, S. Yang, S. Wang, S. Tan, P. Wang,
...
[834]
H. Liu, C. Li, Y. Li, and Y. J. Lee, “Improved base-
lines with visual instruction tuning,” CoRR, vol.
abs/2310.03744, 2023.
[835]
P. Zhang, X. Dong, B. Wang, Y. Cao, C. Xu,
...
[836]
K. Chen, Z. Zhang, W. Zeng, R. Zhang, F. Zhu, and
...
[838]
Y. Du, H. Guo, K. Zhou, W. X. Zhao, J. Wang,
...
[839]
D. Gurari, Q. Li, A. J. Stangl, A. Guo, C. Lin,
...
[842]
C. Fu, P. Chen, Y. Shen, Y. Qin, M. Zhang, X. Lin,
...
136
[843]
Y. Zhang, Y. Li, L. Cui, D. Cai, L. Liu, T. Fu, X. Huang,
...
forum?id=xozJw0kZXF
[848]
D. A. Hudson and C. D. Manning, “GQA: A new
dataset for real-world visual reasoning and compo-
sitional question answering,” in CVPR.
Computer
Vision Foundation / IEEE, 2019, pp. 6700–6709.
[849]
P. Lu, S. Mishra, T. Xia, L. Qiu, K. Chang, S. Zhu,
...
tuning,” CoRR, vol. abs/2304.08485, 2023.
[855]
P. Xu, W. Shao, K. Zhang, P. Gao, S. Liu, M. Lei,
...
2023.
[856]
Z. Li, Y. Wang, M. Du, Q. Liu, B. Wu, J. Zhang,
...
[861]
X. Qi, K. Huang, A. Panda, M. Wang, and P. Mittal,
...
[862]
Y. Zhou, C. Cui, J. Yoon, L. Zhang, Z. Deng, C. Finn,
...
[863]
Z. Sun, S. Shen, S. Cao, H. Liu, C. Li, Y. Shen, C. Gan,
...
[864]
E. Jim´enez-Ruiz, O. Hassanzadeh, V. Efthymiou,
...
[868]
X. Wang, T. Gao, Z. Zhu, Z. Zhang, Z. Liu, J. Li,
...
137
[869]
J. Zhang, X. Zhang, J. Yu, J. Tang, J. Tang, C. Li,
...
5773–5784.
[870]
P. Ke, H. Ji, Y. Ran, X. Cui, L. Wang, L. Song, X. Zhu,
...
2020.
[872]
W. Chen, Y. Su, X. Yan, and W. Y. Wang, “KGPT:
...
8648.
[873]
Y. Gu, X. Deng, and Y. Su, “Don’t generate, discrim-
...
CoRR, vol. abs/2305.13172, 2023.
[878]
S. Choi, T. Fang, Z. Wang, and Y. Song, “KCTS:
...
abs/2310.09044, 2023.
[879]
S. Zhang, L. Pan, J. Zhao, and W. Y. Wang, “Mit-
...
[881]
M. Karpinska, N. Akoury, and M. Iyyer, “The perils
...
abs/2308.07201, 2023.
[888]
R. Li, T. Patel, and X. Du, “PRD: peer rank and dis-
cussion improve large language model based evalu-
ations,” CoRR, vol. abs/2307.02762, 2023.
[889]
L. Zhu, X. Wang, and X. Wang, “Judgelm: Fine-tuned
...
abs/2212.14882, 2022.
[898]
K. Singhal, T. Tu, J. Gottweis, R. Sayres, E. Wul-
...
[899]
S. Yang, H. Zhao, S. Zhu, G. Zhou, H. Xu, Y. Jia, and
...
[910]
F. Yu, L. Quartey, and F. Schilder, “Legal prompting:
...
2023.
[914]
A. Abid, M. Farooqi, and J. Zou, “Persistent anti-
...
2021, pp. 298–306.
[915]
A. Shah and S. Chava, “Zero is not hero yet: Bench-
...
abs/1908.10063, 2019.
[917]
J. C. S. Alvarado, K. Verspoor, and T. Baldwin,
...
2015, B. Hachey and K. Webster, Eds.
ACL, 2015,
pp. 84–90.
[918]
G. Son, H. Jung, M. Hahm, K. Na, and S. Jin, “Beyond
classification: Financial reasoning in state-of-the-art
language models,” CoRR, vol. abs/2305.01505, 2023.
[919]
X. Zhang, Q. Yang, and D. Xu, “Xuanyuan 2.0: A
...
[923]
Z. Bi, N. Zhang, Y. Xue, Y. Ou, D. Ji, G. Zheng,
...
2023.
[924]
C. Zhang, C. Zhang, C. Li, Y. Qiao, S. Zheng, S. K.
...
[925]
M. Haman and M. Skolnik, “Using chatgpt to con-
...
2023.
[941]
kaiokendev, “Things I’m learning while training su-
perhot.” 2023.
[942]
Z. Dong, T. Tang, J. Li, W. X. Zhao, and J. Wen,
...
[943]
J. Su. (2023) Transformer upgrade path: 12, infinite
extrapolation of rerope?
[944]
A. Pal, D. Karkhanis, M. Roberts, S. Dooley, A. Sun-
dararajan, and S. Naidu, “Giraffe: Adventures in
expanding context lengths in llms,” CoRR, vol.
abs/2308.10882, 2023.
[945]
G. Izacard and E. Grave, “Leveraging passage re-
...
[946]
N. Ratner, Y. Levine, Y. Belinkov, O. Ram, I. Magar,
...
[960]
P. Xu, W. Ping, X. Wu, L. McAfee, C. Zhu, Z. Liu,
...
[965]
X. Team, “Xagent: An autonomous agent for complex
task solving,” 2023.
[966]
...
[967]
S. Hong, X. Zheng, J. Chen, Y. Cheng, J. Wang,
...
[968]
C. Pham, B. Liu, Y. Yang, Z. Chen, T. Liu, J. Yuan,
...
[970]
Q. Wu, G. Bansal, J. Zhang, Y. Wu, B. Li, E. Zhu,
...
13 153–13 187.
[973]
W. Hua, X. Yang, Z. Li, W. Cheng, and Y. Zhang,
...
questions,” CoRR, vol. abs/2311.05232, 2023.
[975]
I. Loshchilov and F. Hutter, “Decoupled weight de-
cay regularization,” in ICLR (Poster).
OpenRe-
view.net, 2019.
[976]
V. A. Korthikanti, J. Casper, S. Lym, L. McAfee,
...
chi, I. Qualters, and W. T. Kramer, Eds.
IEEE/ACM,
2020, p. 20.
[978]
J. Ren, S. Rajbhandari, R. Y. Aminabadi, O. Ruwase,
...
[979]
S. Rajbhandari, O. Ruwase, J. Rasley, S. Smith, and
Y. He, “Zero-infinity: breaking the GPU memory wall
for extreme scale deep learning,” in SC.
ACM, 2021,
p. 59.
[980]
...
tention with io-awareness,” in NeurIPS, 2022.
[981]
S. A. Jacobs, M. Tanaka, C. Zhang, M. Zhang, S. L.
...
[984]
Y. Sheng, L. Zheng, B. Yuan, Z. Li, M. Ryabinin,
...
abs/2401.08671, 2024.
[987]
Y. Leviathan, M. Kalman, and Y. Matias, “Fast infer-
ence from transformers via speculative decoding,” in
International Conference on Machine Learning, 2023.
[988]
C. Chen, S. Borgeaud, G. Irving, J. Lespiau, L. Sifre,
...
2018, pp. 479–488.
[995]
T. Cai, Y. Li, Z. Geng, H. Peng, J. D. Lee, D. Chen, and
...
deep neural networks,” in ICPR.
IEEE, 2016, pp.
2464–2469.
[997]
G. Huang, D. Chen, T. Li, F. Wu, L. van der Maaten,
and K. Q. Weinberger, “Multi-scale dense networks
for resource efficient image classification,” in ICLR.
OpenReview.net, 2018.
[998]
D. Raposo, S. Ritter, B. A. Richards, T. P. Lilli-
...
abs/2404.02258, 2024.
[999]
Z. Wan, X. Wang, C. Liu, S. Alam, Y. Zheng,
J.
Liu,
Z.
Qu,
...
sycophancy in language models,” in ICLR.
Open-
Review.net, 2024.
