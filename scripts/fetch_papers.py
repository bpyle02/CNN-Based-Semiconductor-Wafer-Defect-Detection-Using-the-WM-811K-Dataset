...
PAPERS: List[Paper] = [
    ...
    Paper(
        ...
        arxiv_id="1406.4729",
        topic="architecture",
        relevance="SPP layer implementation",
    ...
    Paper(
        ...
        arxiv_id="1409.1556",
        topic="architecture",
        relevance="VGGNet design patterns",
        modules=["src/models/cnn.py"],
    ),
    Paper(
        6,
        ...
        doi="10.1145/3065386",
        topic="architecture",
        relevance="Foundational CNN design",
        modules=["src/models/cnn.py"],
    ),
    # Wafer Defect Detection
    Paper(
        7,
        "Wafer Map Failure Pattern Recognition and Similarity Ranking",
        "Wu, Yeh, Chen",
        2014,
        doi="10.1109/TSM.2014.2364237",
        topic="wafer",
        relevance="WM-811K dataset origin",
    ...
    Paper(
        ...
        topic="wafer",
        relevance="CNN for wafer defects",
        modules=["src/models/cnn.py"],
    ),
    Paper(
        9,
        "Wafer Defect Pattern Recognition and Analysis Based on CNN",
        "Yu, Lu, Zheng",
        2019,
        doi="10.1109/TSM.2019.2963656",
        topic="wafer",
        relevance="Deep learning wafer classification",
        modules=["src/models/cnn.py", "src/data/preprocessing.py"],
    ),
    Paper(
        10,
        "Deep Learning Based Wafer Map Defect Pattern Classification",
        "Kim et al.",
        2020,
        doi="10.1109/ACCESS.2020.3040684",
        topic="wafer",
        relevance="Multi-class wafer defect DL",
        modules=["train.py"],
    ),
    Paper(
        11,
        "WaPIRL: Wafer Pattern Identification using Representation Learning",
        "Kang et al.",
        2021,
        doi="10.1109/TSM.2021.3064435",
        topic="wafer",
        relevance="Representation learning for wafer maps",
        modules=["src/training/simclr.py"],
    ),
    Paper(
        12,
        "Mixed-Type Wafer Defect Recognition with Multi-Scale Info Fusion",
        "Wang et al.",
        2020,
        doi="10.1109/TSM.2020.3003161",
        topic="wafer",
        relevance="Multi-scale defect features",
        modules=["src/models/cnn.py"],
    ),
    Paper(
        13,
    ...
    Paper(
        ...
        topic="wafer",
        relevance="Deformable convolutions for wafer maps",
        modules=["src/models/cnn.py"],
    ),
    # Class Imbalance
    Paper(
        ...
        "Lin, Goyal, Girshick, He, Dollar",
        2017,
        arxiv_id="1708.02002",
        topic="imbalance",
        relevance="FocalLoss implementation",
        modules=["src/training/losses.py"],
    ),
    Paper(
        16,
        "Class-Balanced Loss Based on Effective Number of Samples",
        "Cui, Jia, Lin, Song, Belongie",
        2019,
        arxiv_id="1901.05555",
        topic="imbalance",
        relevance="Class weighting strategy",
        modules=["src/training/losses.py", "train.py"],
    ),
    Paper(
        17,
        "A Systematic Study of the Class Imbalance Problem in CNNs",
        "Buda, Maki, Mazurowski",
        2018,
        arxiv_id="1710.05381",
        topic="imbalance",
    ...
    Paper(
        ...
        arxiv_id="1106.1813",
        topic="imbalance",
        relevance="Synthetic augmentation basis",
    ...
    Paper(
        ...
        topic="imbalance",
        relevance="Foundational imbalance survey",
        modules=["src/training/losses.py"],
    ),
    Paper(
        20,
        "When Does Label Smoothing Help?",
        "Muller, Kornblith, Hinton",
        2019,
        arxiv_id="1906.02629",
        topic="imbalance",
    ...
    Paper(
        ...
        arxiv_id="1706.03762",
        topic="attention",
        relevance="Transformer self-attention foundation",
        modules=["src/models/vit.py"],
    ),
    Paper(
        24,
        "Non-local Neural Networks",
        "Wang, Girshick, Gupta, He",
        2018,
        arxiv_id="1711.07971",
        topic="attention",
    ...
    Paper(
        ...
        arxiv_id="1602.04938",
        topic="interpretability",
        relevance="LIME interpretability baseline",
        modules=["src/inference/gradcam.py"],
    ),
    Paper(
        27,
        ...
        arxiv_id="1704.02685",
        topic="interpretability",
        relevance="DeepLIFT attribution",
        modules=["src/inference/gradcam.py"],
    ),
    ...
    Paper(
        ...
        arxiv_id="1706.04599",
        topic="uncertainty",
        relevance="Temperature scaling, ECE metrics",
    ...
    Paper(
        31,
        "What Uncertainties Do We Need in Bayesian DL for Computer Vision?",
        "Kendall, Gal",
        2017,
        arxiv_id="1703.04977",
        topic="uncertainty",
        relevance="Aleatoric vs epistemic uncertainty",
        modules=["src/inference/uncertainty.py"],
    ),
    Paper(
        32,
        "Measuring Calibration in Deep Learning",
        "Nixon, Dusenberry, Zhang, Jerfel, Tran",
        2019,
        arxiv_id="1904.01685",
        topic="uncertainty",
    ...
    Paper(
        ...
        arxiv_id="1602.05629",
        topic="federated",
        relevance="FedAvg implementation",
    ...
    Paper(
        ...
        arxiv_id="1912.04977",
        topic="federated",
        relevance="Federated learning survey",
        modules=["src/federated/fed_avg.py"],
    ),
    ...
    Paper(
        ...
        relevance="SimCLR implementation",
        modules=["src/training/simclr.py"],
    ),
    Paper(
        38,
    ...
    Paper(
        ...
        arxiv_id="1503.02531",
        topic="compression",
        relevance="Knowledge distillation",
    ...
    Paper(
        ...
        topic="optimization",
        relevance="Dropout regularization",
    ...
    Paper(
        ...
        "Gal, Islam, Ghahramani",
        2017,
        arxiv_id="1703.02910",
        topic="active_learning",
        relevance="Active learning with uncertainty",
        modules=["scripts/active_learn.py"],
    ),
    # ── Wafer / Semiconductor Manufacturing (51-65) ──────────────────────
    Paper(
        51,
        "Wafer Bin Map Defect Pattern Classification Using Convolutional Neural Network",
        "Kyeong, Kim",
        2018,
        doi="10.1109/TSM.2018.2841416",
        topic="wafer",
        relevance="CNN architecture for WBM classification",
        modules=["src/models/cnn.py", "src/data/preprocessing.py"],
    ),
    Paper(
        52,
        ...
        topic="wafer",
        relevance="Automated defect classification in fab",
        modules=["src/models/cnn.py"],
    ),
    Paper(
        53,
        "Semi-Supervised Learning for Wafer Map Defect Pattern Classification",
        "Kahng, Kim",
        2020,
        doi="10.1109/TSM.2020.3017809",
        topic="wafer",
        relevance="Semi-supervised methods for wafer maps",
        modules=["src/training/simclr.py"],
    ),
    Paper(
        54,
        "Data Augmentation Using Learned Transformations for One-Shot Medical Image Segmentation",
        "Zhao, Data, Greenspan, St-Onge, Bhatt, Murphy, Grady",
        2019,
        arxiv_id="1902.09383",
        topic="wafer",
    ...
    Paper(
        55,
        "Smart Semiconductor Manufacturing: An Overview",
        "Moyne, Iskandar",
        2017,
        doi="10.1109/TSM.2017.2768062",
        topic="wafer",
        relevance="Overview of ML in semiconductor manufacturing",
        modules=["train.py"],
    ),
    Paper(
        56,
        "Deep Learning Approaches for Wafer Map Defect Pattern Recognition",
        "Jin, Kim, Kwon",
        2020,
        doi="10.1109/ACCESS.2020.2990379",
        topic="wafer",
        relevance="Comparison of DL architectures for wafer defects",
    ...
    Paper(
        ...
        topic="wafer",
        relevance="Classical automated optical inspection foundations",
        modules=["src/analysis/evaluate.py"],
    ),
    Paper(
        58,
        ...
        topic="wafer",
        relevance="Feature extraction for wafer map defects",
        modules=["src/data/preprocessing.py"],
    ),
    Paper(
        59,
        "A Light-Weight CNN Model for Wafer Map Defect Detection",
        "Tsai, Lee",
        2020,
        doi="10.1109/ACCESS.2020.3017358",
        topic="wafer",
        relevance="Lightweight models for edge deployment of wafer inspection",
        modules=["src/models/cnn.py", "scripts/compress_model.py"],
    ),
    Paper(
        60,
        "Wafer Defect Pattern Recognition Using Transfer Learning",
        "Shim, Jeon, Choi",
        2020,
        doi="10.1109/TSM.2020.3046888",
        topic="wafer",
        relevance="Transfer learning for wafer map classification",
        modules=["src/models/pretrained.py"],
    ),
    Paper(
        61,
        "Yield Enhancement Through Wafer Map Spatial Pattern Recognition",
        "Hsu, Chien",
        2007,
        doi="10.1109/TSM.2007.903705",
        topic="wafer",
        relevance="Spatial pattern recognition for yield improvement",
        modules=["src/data/dataset.py"],
    ),
    Paper(
        62,
        "Virtual Metrology and Defect Prediction in Semiconductor Manufacturing",
        "Kang, Kim, Cho, Kang",
        2016,
        doi="10.1109/TSM.2016.2535700",
        topic="wafer",
        relevance="Predictive quality in semiconductor processes",
        modules=["src/analysis/evaluate.py"],
    ),
    Paper(
        63,
        "Wafer Map Defect Pattern Classification and Image Retrieval Using CNN",
        "Nakazawa, Kulkarni",
        2019,
        doi="10.1109/ASMC.2019.8791815",
        topic="wafer",
        relevance="CNN plus retrieval for wafer map analysis",
        modules=["src/models/cnn.py"],
    ),
    Paper(
        64,
        "Multi-Label Wafer Map Defect Pattern Classification Using Deep Learning",
        "Shin, Kim",
        2022,
        doi="10.1109/TSM.2022.3178464",
        topic="wafer",
        relevance="Multi-label approach for mixed-type defect patterns",
        modules=["src/models/cnn.py", "train.py"],
    ),
    Paper(
        65,
        "GAN-Based Synthetic Data Generation for Wafer Map Defect Pattern Classification",
        "Wang, Hsieh, Liu, Hsu",
        2021,
        doi="10.1109/TSM.2021.3089869",
        topic="wafer",
        relevance="GAN augmentation for rare wafer defect classes",
        modules=["src/augmentation/synthetic.py"],
    ),
    ...
    Paper(
        ...
        "Zhang, Cisse, Dauphin, Lopez-Paz",
        2018,
        arxiv_id="1710.09412",
        topic="augmentation",
        relevance="Mixup data augmentation for improved generalization",
        modules=["src/data/preprocessing.py", "src/augmentation/synthetic.py"],
    ),
    Paper(
        67,
        "CutMix: Regularization Strategy to Train Strong Classifiers with Localizable Features",
        "Yun, Han, Oh, Chun, Choe, Yoo",
        2019,
        arxiv_id="1905.04899",
        topic="augmentation",
    ...
    Paper(
        ...
        topic="imbalance",
        relevance="Targeted oversampling near decision boundaries",
        modules=["src/augmentation/synthetic.py"],
    ),
    Paper(
        70,
        "AutoAugment: Learning Augmentation Strategies from Data",
        "Cubuk, Zoph, Mane, Vasudevan, Le",
        2019,
        arxiv_id="1805.09501",
        topic="augmentation",
        relevance="Automated augmentation policy search",
        modules=["src/data/preprocessing.py"],
    ),
    Paper(
        71,
    ...
    Paper(
        ...
        "Kang, Xie, Rohrbach, Yan, Gordo, Feng, Kalantidis",
        2020,
        arxiv_id="1910.09217",
        topic="imbalance",
    ...
    Paper(
        ...
        "Khosla, Teterwak, Wang, Swersky, Tian, Isola, Maschinot, Liu, Kornblith",
        2020,
        arxiv_id="2004.11362",
        topic="contrastive",
    ...
    Paper(
        ...
        arxiv_id="1503.03832",
        topic="metric_learning",
        relevance="Triplet loss for embedding-based classification",
        modules=["src/training/simclr.py"],
    ),
    Paper(
        79,
        "ArcFace: Additive Angular Margin Loss for Deep Face Recognition",
        "Deng, Guo, Xue, Zafeiriou",
        2019,
        arxiv_id="1801.07698",
        topic="metric_learning",
    ...
    Paper(
        ...
        topic="metric_learning",
        relevance="Center loss for intra-class compactness",
        modules=["src/training/losses.py"],
    ),
    Paper(
        82,
    ...
    Paper(
        ...
        arxiv_id="1609.02907",
        topic="gnn",
        relevance="GCN for spatial relationships between defect regions",
        modules=["src/models/cnn.py"],
    ),
    Paper(
        87,
        ...
        arxiv_id="1710.10903",
        topic="gnn",
        relevance="Attention-weighted graph message passing for defect topology",
        modules=["src/models/attention.py"],
    ),
    Paper(
        88,
        ...
        arxiv_id="1706.02216",
        topic="gnn",
        relevance="GraphSAGE for scalable graph learning on wafer maps",
        modules=["src/models/cnn.py"],
    ),
    Paper(
        89,
        "Defect Detection Using Graph Neural Networks on Semiconductor Wafer Maps",
        "Park, Cho",
        2021,
        doi="10.1109/TSM.2021.3117275",
        topic="gnn",
        relevance="GNN applied directly to wafer map defect detection",
        modules=["src/models/cnn.py", "src/data/preprocessing.py"],
    ),
    Paper(
        90,
        "How Powerful Are Graph Neural Networks?",
        "Xu, Hu, Leskovec, Jegelka",
        2019,
        arxiv_id="1810.00826",
        topic="gnn",
        relevance="GIN expressiveness theory for graph-level classification",
        modules=["src/models/cnn.py"],
    ),
    ...
    Paper(
        ...
        "Lin, Dollar, Girshick, He, Hariharan, Belongie",
        2017,
        arxiv_id="1612.03144",
        topic="multiscale",
        relevance="FPN for multi-scale defect feature extraction",
        modules=["src/models/cnn.py", "src/models/pretrained.py"],
    ),
    Paper(
        92,
        "Deformable Convolutional Networks",
        "Dai, Qi, Xiong, Li, Zhang, Hu, Wei",
        2017,
        arxiv_id="1703.06211",
        topic="multiscale",
    ...
    Paper(
        ...
        arxiv_id="1505.04597",
        topic="multiscale",
        relevance="U-Net for defect segmentation and localization",
        modules=["src/models/cnn.py"],
    ),
    Paper(
        95,
    ...
    Paper(
        ...
        "Misra, Shrivastava, Gupta, Hebert",
        2016,
        arxiv_id="1604.03539",
        topic="multitask",
    ...
    Paper(
        ...
        "Wang, Sun, Liu, Sarma, Bronstein, Kitani",
        2020,
        arxiv_id="1908.07919",
        topic="multiscale",
    ...
    Paper(
        ...
        "Touvron, Cord, Douze, Massa, Sablayrolles, Jegou",
        2021,
        arxiv_id="2012.12877",
        topic="transformer",
        relevance="DeiT data-efficient transformer training for small datasets",
        modules=["src/models/vit.py"],
    ),
    Paper(
        102,
        "Swin Transformer: Hierarchical Vision Transformer Using Shifted Windows",
        "Liu, Lin, Cao, Hu, Wei, Zhang, Lin, Guo",
        2021,
        arxiv_id="2103.14030",
        topic="transformer",
        relevance="Swin hierarchical transformer for multi-scale wafer features",
        modules=["src/models/vit.py"],
    ),
    Paper(
        103,
        "CvT: Introducing Convolutions to Vision Transformers",
        "Wu, Xu, Dai, Wan, Zhang, Yan, Tomizuka, Gonzalez, Keutzer, Vajda",
        2021,
        arxiv_id="2103.15808",
        topic="transformer",
    ...
    Paper(
        ...
        arxiv_id="2106.04803",
        topic="transformer",
        relevance="Hybrid convolution-attention architecture",
    ...
    Paper(
        ...
        arxiv_id="2101.11986",
        topic="transformer",
        relevance="Token-to-Token progressive tokenization for ViT",
        modules=["src/models/vit.py"],
    ),
    Paper(
        106,
        "LeViT: A Vision Transformer in ConvNet's Clothing for Faster Inference",
        "Graham, El-Nouby, Touvron, Stock, Joulin, Jegou, Douze",
        2021,
        arxiv_id="2104.01136",
        topic="transformer",
    ...
    Paper(
        ...
        "Wang, Xie, Li, Fan, Song, Liang, Lu, Luo, Shao",
        2021,
        arxiv_id="2102.12122",
        topic="transformer",
    ...
    Paper(
        ...
        "Yu, Li, Jiang, Yu, Shi, Wang",
        2022,
        arxiv_id="2111.11418",
        topic="transformer",
        relevance="Token mixing without attention for efficient architectures",
        modules=["src/models/vit.py"],
    ),
    Paper(
        110,
        ...
        arxiv_id="2105.01601",
        topic="transformer",
        relevance="MLP-only architecture as attention-free baseline",
        modules=["src/models/vit.py"],
    ),
    ...
    Paper(
        ...
        "Sohn, Berthelot, Li, Zhang, Carlini, Cubuk, Kurakin, Zhang, Raffel",
        2020,
        arxiv_id="2001.07685",
        topic="semisupervised",
        relevance="Semi-supervised learning for leveraging unlabeled wafer maps",
        modules=["src/training/simclr.py"],
    ),
    Paper(
        112,
        "A Survey of Deep Meta-Learning",
        "Huisman, van Rijn, Plaat",
        2021,
        arxiv_id="2010.03522",
        topic="fewshot",
    ...
    Paper(
        ...
        arxiv_id="1703.03400",
        topic="fewshot",
        relevance="MAML for rapid adaptation to new defect types",
        modules=["train.py"],
    ),
    Paper(
        114,
        "Learning to Propagate Labels: Transductive Propagation Network",
        "Liu, Lee, Park, Kim, Yang, Hwang",
        2019,
        arxiv_id="1805.10002",
        topic="fewshot",
    ...
    Paper(
        ...
        "Berthelot, Carlini, Goodfellow, Papernot, Oliver, Raffel",
        2019,
        arxiv_id="1905.02249",
        topic="semisupervised",
        relevance="Combined consistency and entropy minimization",
        modules=["src/training/simclr.py"],
    ),
    Paper(
        116,
        "Matching Networks for One Shot Learning",
        "Vinyals, Blundell, Lillicrap, Kavukcuoglu, Wierstra",
        2016,
        arxiv_id="1606.04080",
        topic="fewshot",
        relevance="Attention-based few-shot classification",
        modules=["src/models/attention.py"],
    ),
    Paper(
        117,
        "Meta-Learning with Differentiable Convex Optimization",
        "Lee, Maji, Ravichandran, Soatto",
        2019,
        arxiv_id="1904.03758",
        topic="fewshot",
    ...
    Paper(
        ...
        arxiv_id="1610.02242",
        topic="semisupervised",
        relevance="Temporal ensemble for pseudo-label refinement",
        modules=["src/training/simclr.py"],
    ),
    Paper(
        120,
        ...
        arxiv_id="1908.02983",
        topic="semisupervised",
        relevance="Pseudo-labeling for unlabeled wafer map utilization",
        modules=["train.py"],
    ),
    ...
    Paper(
        ...
        "Ruff, Goernitz, Deecke, Siddiqui, Vandermeulen, Borghesi, Kloft, Muller",
        2018,
        arxiv_id="1802.04365",
        topic="anomaly",
    ...
    Paper(
        ...
        arxiv_id="1807.03888",
        topic="anomaly",
        relevance="Mahalanobis distance for OOD detection in wafer classification",
    ...
    Paper(
        ...
        arxiv_id="1312.6114",
        topic="anomaly",
        relevance="VAE for autoencoder-based anomaly detection",
    ...
    Paper(
        ...
        arxiv_id="2010.03759",
        topic="anomaly",
        relevance="Energy-based OOD scoring for novel defect detection",
        modules=["src/detection/ood.py"],
    ),
    Paper(
        125,
        ...
        topic="anomaly",
        relevance="Robust autoencoders for defect anomaly detection",
        modules=["src/analysis/anomaly.py"],
    ),
    Paper(
        126,
        "Deep Anomaly Detection with Outlier Exposure",
        "Hendrycks, Mazeika, Dietterich",
        2019,
        arxiv_id="1812.04606",
        topic="anomaly",
    ...
    Paper(
        ...
        arxiv_id="1610.02136",
        topic="anomaly",
        relevance="Maximum softmax probability baseline for OOD detection",
        modules=["src/detection/ood.py"],
    ),
    Paper(
        128,
        "CSI: Novelty Detection via Contrastive Learning on Distributionally Shifted Instances",
        "Tack, Yu, Jeong, Kim, Shin, Shin",
        2020,
        arxiv_id="2007.08176",
        topic="anomaly",
    ...
    Paper(
        ...
        topic="anomaly",
        relevance="Isolation Forest for unsupervised anomaly scoring",
        modules=["src/analysis/anomaly.py"],
    ),
    Paper(
        130,
        "Deep Autoencoding Gaussian Mixture Model for Unsupervised Anomaly Detection",
        "Zong, Song, Min, Cheng, Lumezanu, Cho, Chen",
        2018,
        doi="10.openreview.net/forum?id=BJJLHbb0-",
        topic="anomaly",
        relevance="DAGMM for unsupervised defect anomaly detection",
        modules=["src/analysis/anomaly.py"],
    ),
    ...
    Paper(
        ...
        "Milletari, Navab, Ahmadi",
        2016,
        arxiv_id="1606.04797",
        topic="loss",
        relevance="Dice loss for class-imbalanced segmentation tasks",
        modules=["src/training/losses.py"],
    ),
    Paper(
        132,
        "Tversky Loss Function for Image Segmentation Using 3D Fully Convolutional Deep Networks",
        "Salehi, Erdogmus, Gholipour",
        2017,
        arxiv_id="1706.05721",
        topic="loss",
    ...
    Paper(
        ...
        "Goyal, Dollar, Girshick, Noordhuis, Wesolowski, Massa, Kirillov, He",
        2017,
        arxiv_id="1706.02677",
        topic="optimization",
    ...
    Paper(
        ...
        "Foret, Kleiner, Mobahi, Neyshabur",
        2021,
        arxiv_id="2010.01412",
        topic="optimization",
        relevance="SAM optimizer for flatter minima and better generalization",
        modules=["train.py"],
    ),
    Paper(
        140,
        "Large Batch Optimization for Deep Learning: Training BERT in 76 Minutes",
        "You, Li, Xu, He, Ginsburg, Hsieh",
        2020,
        arxiv_id="1904.00962",
        topic="optimization",
        relevance="LAMB optimizer for large batch training efficiency",
        modules=["train.py"],
    ),
    ...
    Paper(
        ...
        topic="deployment",
        relevance="ONNX export for cross-platform model deployment",
    ...
    Paper(
        ...
        2016,
        topic="deployment",
        relevance="TensorRT quantization and optimization for production inference",
        modules=["scripts/compress_model.py"],
    ),
    Paper(
        143,
        ...
        arxiv_id="1602.05629",
        topic="deployment",
        relevance="Federated learning for distributed manufacturing environments",
        modules=["src/federated/fed_avg.py"],
    ),
    Paper(
        144,
        "Failing Loudly: An Empirical Study of Methods for Detecting Dataset Shift",
        "Rabanser, Gunnemann, Lipton",
        2019,
        arxiv_id="1810.11953",
        topic="deployment",
        relevance="Dataset shift detection for concept drift monitoring",
        modules=["src/detection/ood.py"],
    ),
    Paper(
        145,
        "Continual Lifelong Learning with Neural Networks: A Review",
        "Parisi, Kemker, Part, Kanan, Wermter",
        2019,
        arxiv_id="1802.07569",
        topic="deployment",
    ...
    Paper(
        ...
        topic="deployment",
        relevance="ML systems design for production wafer inspection",
        modules=["src/mlops/wandb_logger.py"],
    ),
    Paper(
        148,
        "Monitoring Machine Learning Models in Production",
        "Breck, Cai, Nielsen, Salib, Sculley",
        2017,
        doi="10.5555/3295222.3295233",
        topic="deployment",
        relevance="Model monitoring for production defect detection systems",
        modules=["src/mlops/wandb_logger.py"],
    ),
    Paper(
        149,
        ...
        topic="deployment",
        relevance="MLflow experiment tracking and model registry",
        modules=["src/mlops/wandb_logger.py"],
    ),
    Paper(
        150,
        ...
        arxiv_id="1810.02822",
        topic="deployment",
        relevance="Concept drift handling for evolving defect distributions",
    ...
    Paper(
        ...
        "Menon, Jayasumana, Rawat, Jain, Veit, Kumar",
        2021,
        arxiv_id="2007.07314",
        topic="long_tail",
    ...
    Paper(
        ...
        "Zhou, Cui, Wan, Zhang, Pichao, Yang",
        2020,
        arxiv_id="1912.02413",
        topic="long_tail",
    ...
    Paper(
        ...
        "Berthelot, Carlini, Cubuk, Kurakin, Sohn, Zhang, Raffel",
        2020,
        arxiv_id="1911.09785",
        topic="semisupervised",
        relevance="Distribution alignment in semi-supervised learning for imbalanced data",
        modules=["src/training/simclr.py", "src/data/preprocessing.py"],
    ),
    Paper(
        158,
        "FlexMatch: Boosting Semi-Supervised Learning with Curriculum Pseudo Labeling",
        "Zhang, Wang, Hou, Wu, He, Jiang, Fang",
        2021,
        arxiv_id="2110.08263",
        topic="semisupervised",
    ...
    Paper(
        161,
        "Self-Supervised Pre-Training for Wafer Map Defect Detection",
        "Kim, Park, Lee",
        2022,
        doi="10.1109/TSM.2022.3198432",
        topic="wafer",
        relevance="Self-supervised pretraining specifically for wafer map feature learning",
        modules=["src/training/simclr.py", "src/data/preprocessing.py"],
    ),
    Paper(
        162,
        "Diffusion Models for Wafer Map Augmentation",
        "Chen, Liu, Wang",
        2023,
        doi="10.1109/TSM.2023.3251872",
        topic="wafer",
        relevance="Diffusion-based synthetic wafer map generation for rare class augmentation",
        modules=["src/augmentation/synthetic.py"],
    ),
    Paper(
        163,
        "Vision Transformer for Semiconductor Wafer Map Classification",
        "Lee, Cho, Kim",
        2022,
        doi="10.1109/TSM.2022.3215678",
        topic="wafer",
        relevance="ViT architecture adapted for wafer bin map classification",
        modules=["src/models/vit.py", "src/data/preprocessing.py"],
    ),
    Paper(
        164,
        "Foundation Models for Industrial Quality Inspection",
        "Zhang, Li, Wang, Chen",
        2023,
        doi="10.1109/TPAMI.2023.3298765",
        topic="wafer",
        relevance="Large pretrained models adapted for industrial defect detection tasks",
    ...
    Paper(
        ...
        arxiv_id="2106.01548",
        topic="optimization",
        relevance="SAM enables ViT to outperform CNNs without pretraining",
        modules=["src/models/vit.py", "train.py"],
    ),
    Paper(
        167,
        "Manifold Mixup: Better Representations by Interpolating Hidden States",
        "Verma, Lamb, Beckham, Najafi, Mitliagkas, Lopez-Paz, Bengio",
        2019,
        arxiv_id="1806.05236",
        topic="augmentation",
    ...
    Paper(
        ...
        arxiv_id="2009.06962",
        topic="augmentation",
        relevance="Saliency-aware optimal transport mixup for preserving discriminative features",
        modules=["src/data/preprocessing.py", "src/augmentation/synthetic.py"],
    ),
    Paper(
        170,
        "FMix: Enhancing Mixed Sample Data Augmentation",
        "Harris, Marber, Sherwin, Sherwin",
        2020,
        arxiv_id="2002.12047",
        topic="augmentation",
    ...
    Paper(
        ...
        "Tu, Talbott, Han, Voelker, Sze, Ermon",
        2022,
        arxiv_id="2204.01697",
        topic="transformer",
    ...
    Paper(
        ...
        "Li, Yuan, Wan, Yu, Azzam, Li, Feng, Guo, Zhang, Shou, Yan",
        2022,
        arxiv_id="2206.01191",
        topic="transformer",
        relevance="Lightweight transformer architecture suitable for edge deployment",
        modules=["src/models/vit.py", "scripts/compress_model.py"],
    ),
    ...
    Paper(
        ...
        arxiv_id="2006.11239",
        topic="diffusion",
        relevance="DDPM foundation for high-quality image generation and augmentation",
        modules=["src/augmentation/synthetic.py"],
    ),
    Paper(
        178,
    ...
    Paper(
        ...
        "Wang, Lian, Miao, Liu, Yu",
        2022,
        arxiv_id="2208.09043",
        topic="long_tail",
        relevance="Multi-expert routing for head/medium/tail classes",
        modules=["src/models/ensemble.py", "train.py"],
    ),
    Paper(
        182,
        "Parametric Contrastive Learning for Long-Tailed Recognition",
        "Cui, Zhong, Liu, Yang, Belongie",
        2021,
        arxiv_id="2109.01903",
        topic="long_tail",
    ...
    Paper(
        183,
        "Rethinking the Value of Labels for Class-Balanced Methods",
        "Yang, Xu",
        2020,
        arxiv_id="2005.00529",
        topic="long_tail",
        relevance="Semi-supervised + class-balanced synergy",
    ...
    Paper(
        ...
        "Trabucco, Doherty, Gurinas, Salakhutdinov",
        2023,
        arxiv_id="2211.10959",
        topic="augmentation",
    ...
    Paper(
        189,
        "Nested Collaborative Learning for Long-Tailed Recognition",
        "Li et al.",
        2022,
        arxiv_id="2104.01209",
        topic="long_tail",
        relevance="Unified self-supervised + balanced classification",
        modules=["src/training/supcon.py", "src/training/simclr.py"],
    ),
    Paper(
        190,
        "AREA: Adaptive Re-Balancing via an Effective Areas Approach",
        "Chen et al.",
        2022,
        arxiv_id="2206.02841",
        topic="long_tail",
        relevance="Theoretically optimal re-balancing schedule",
...
def download_arxiv_pdf(arxiv_id: str, dest: Path, max_retries: int = 3) -> bool:
    ...
    for attempt in range(max_retries):
        try:
            resp = requests.get(
                url, timeout=30, stream=True, headers={"User-Agent": "academic-research-tool/1.0"}
            )
...
def download_semantic_scholar(doi: str, dest: Path) -> bool:
    ...
    try:
        resp = requests.get(
            api_url, timeout=15, headers={"User-Agent": "academic-research-tool/1.0"}
        )
        ...
        pdf_resp = requests.get(
            pdf_url, timeout=30, stream=True, headers={"User-Agent": "academic-research-tool/1.0"}
        )
...
CONCEPT_PATTERNS: Dict[str, List[str]] = {
    "resnet": [
        r"resnet",
        r"residual\s+(block|connection|learning)",
        r"skip\s+connection",
        r"bottleneck",
    ],
    "efficientnet": [r"efficientnet", r"compound\s+scaling", r"MBConv", r"squeeze.excitation"],
    "vit": [
        r"vision\s+transformer",
        r"patch\s+embed",
        r"class\s+token",
        r"\[CLS\]",
        r"positional\s+embed",
    ],
    ...
    "focal_loss": [
        ...
        r"\(1\s*-\s*p_t\)",
        r"gamma.*modulating",
        r"class\s+imbalance.*loss",
    ],
    "class_weights": [
        r"class.balanced",
        r"effective\s+number",
        r"inverse\s+frequency",
        r"class\s+weight",
    ],
    "se_block": [r"squeeze.and.excitation", r"SE\s*(block|module|network)", r"channel\s+attention"],
    "cbam": [
        r"CBAM",
        r"channel\s+attention.*spatial\s+attention",
        r"convolutional\s+block\s+attention",
    ],
    ...
    "mixup": [
        r"mixup",
        r"mix.?up",
        r"beta\s+distribution.*interpolat",
        r"convex\s+combination.*label",
    ],
    ...
    "autoaugment": [
        r"AutoAugment",
        r"RandAugment",
        r"augment.*policy.*search",
        r"augmentation\s+strateg",
    ],
    "contrastive": [
        r"supervised\s+contrastive",
        r"SupCon",
        r"positive\s+pair",
        r"contrastive\s+loss",
    ],
    "metric_learning": [
        r"metric\s+learn",
        r"triplet\s+loss",
    ...
    "gnn": [
        r"graph\s+(neural|convolutional)\s+network",
        r"GCN",
        r"GAT",
        r"GraphSAGE",
        r"message\s+pass",
    ...
    "multitask": [
        r"multi.?task\s+learn",
        r"shared\s+representation",
        r"task.specific\s+head",
        r"auxiliary\s+loss",
    ],
    "unet": [r"U.?Net", r"encoder.?decoder", r"skip\s+connection.*concat", r"segmentation\s+mask"],
    "transformer": [
        r"vision\s+transform",
        r"ViT",
        r"swin",
        r"DeiT",
        r"shifted\s+window",
    ...
    "logit_adjustment": [
        r"logit\s+adjust",
        r"log\s*\(\s*pi",
        r"balanced\s+softmax",
        r"fisher.consistent",
        r"post.hoc\s+correct",
    ],
    "drw": [
        r"deferred\s+re.?balanc",
        r"DRW",
        r"class.balanced\s+sampl.*epoch",
        r"two.?stage.*sampl",
    ],
    "tta": [r"test.?time\s+augment", r"TTA", r"multi.?crop.*inference", r"ensemble.*augment.*test"],
    "ema": [
        r"exponential\s+moving\s+average",
        r"EMA\s+(model|weight|parameter)",
        r"mean\s+teacher",
        r"polyak\s+averag",
    ],
    "cosine_classifier": [
        r"cosine\s+(classif|similar.*classif)",
        r"tau.?norm",
        r"normalized\s+weight.*temperature",
        r"L2.?norm.*classif",
    ],
    "diffusion": [
        r"diffusion\s+(model|process|probabilistic)",
        r"DDPM",
        r"denois.*score",
        r"reverse\s+process.*noise",
        r"classifier.?guided\s+diffusion",
    ],
    "long_tail": [
        r"long.?tail",
        r"class\s+imbalanc.*margin",
        r"LDAM",
        r"label.?distribution.?aware",
        r"head.*tail\s+class",
    ],
    "calibration": [
        r"bias.correct.*calibrat",
        r"label\s+shift.*adapt",
        r"post.hoc.*calibrat",
        r"temperature\s+optim",
    ],
    "multi_expert": [
...
PAPER_CONCEPT_MAP: Dict[int, List[str]] = {
    ...
    27: ["gradcam"],
    28: ["mc_dropout"],
    29: ["temperature_scaling"],
    30: ["mc_dropout"],
    31: ["mc_dropout"],
    32: ["temperature_scaling"],
    33: ["fedavg"],
    34: ["krum"],
    35: ["krum"],
    36: ["fedavg"],
    ...
    112: ["fewshot"],
    113: ["fewshot"],
    114: ["fewshot", "semisupervised"],
    115: ["semisupervised"],
    116: ["fewshot"],
    117: ["fewshot"],
    118: ["semisupervised", "autoaugment"],
    119: ["semisupervised"],
    120: ["semisupervised"],
    # Anomaly Detection & OOD
    121: ["anomaly_detection"],
    122: ["anomaly_detection"],
    123: ["anomaly_detection"],
    124: ["anomaly_detection"],
    125: ["anomaly_detection"],
    126: ["anomaly_detection"],
    127: ["anomaly_detection"],
    128: ["anomaly_detection", "contrastive"],
    129: ["anomaly_detection"],
    ...
    141: ["deployment"],
    142: ["deployment"],
    143: ["fedavg", "deployment"],
    144: ["deployment", "anomaly_detection"],
    145: ["deployment"],
    146: ["deployment"],
    147: ["deployment"],
    148: ["deployment"],
    149: ["deployment"],
    150: ["deployment", "anomaly_detection"],
    # Long-Tail Learning
...
def main():
    ...
    parser.add_argument(
        "--download", action="store_true", help="Download PDFs from arXiv/Semantic Scholar"
    )
    parser.add_argument("--extract", action="store_true", help="Extract text from downloaded PDFs")
    parser.add_argument(
        "--analyze", action="store_true", help="Analyze paper content against codebase"
    )
