...
from src.training.distributed import (
    ...
    get_rank, get_world_size, wrap_model_dataparallel, wrap_model_distributed
)
...
def load_and_preprocess(
    ...
    if is_distributed():
        train_sampler_cnn = DistributedSampler(
            train_dataset_cnn, num_replicas=get_world_size(), rank=get_rank(),
...
def main():
    ...
    parser.add_argument('--device-ids', type=str, default=None, help='GPU IDs (comma-separated, for DataParallel)')
